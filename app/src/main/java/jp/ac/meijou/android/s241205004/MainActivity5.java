...
import jp.ac.meijou.android.s241205004.databinding.ActivityMain5Binding;
import jp.ac.meijou.android.s241205004.databinding.ActivityMainBinding;
import okhttp3.Call;
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                Optional.ofNullable(gist)
                        ...
                        .ifPresent(gistFile -> {
                            ...
                            runOnUiThread(() -> binding.texstview.setText(gistFile.content));
                        });
